...
class MyDateTime
{
    ...
    {
        if (!is_numeric($date1)) {
            $date1 = MyDateTime::timeStringToStamp($date1);
        }
        if (!is_numeric($date2)) {
            $date2 = MyDateTime::timeStringToStamp($date2);
        }
        if ($date1 < $date2) {
            return -1;
        } else if ($date1 > $date2) {
    ...
    {
        if (!is_numeric($time)) {
            $time = MyDateTime::timeStringToStamp($time);
        }
        ...
        return MyDateTime::timeStampToString($time, $format);
    }
